...
VALUES ('Анастасия', 'Крюковская', 'Алексеевна', 89118330761);

INSERT INTO UserInformation (name, surname, patronymic, phone)
VALUES ('Виктор', 'Петров', 'Андреевич', 84448770101);

INSERT INTO UserInformation (name, surname, patronymic, phone)
VALUES ('Екатерина', 'Козлова', 'Романовна', 89347779900);
...
INSERT INTO Users (user_information_id, role_id, email, password)
VALUES (1, 2, 'i.nastya897@gmail.com', SHA1('Nastya09042002'));

INSERT INTO Users (user_information_id, role_id, email, password)
VALUES (2, 1, 'victor.petrov@gmail.com', SHA1('Victor123'));

INSERT INTO Users (user_information_id, role_id, email, password)
VALUES (3, 1, '17ekaterina17@mail.ru', SHA1('12345678'));

/* todo --------------filling in the table "UserOrders"---------------------*/
INSERT INTO UserOrders (address, order_date, delivery_date, status)
VALUES ('г. Москва, ул. Лилий д. 22', '2021-08-25', '2021-08-27', 'ожидается');

INSERT INTO UserOrders (address, order_date, delivery_date, status)
VALUES ('г. Саект-Петербург, ул. Васильков д. 28', '2021-08-24', '2021-08-27','ожидается');

INSERT INTO UserOrders (address, order_date, delivery_date, status)
VALUES ('г. Воронеж, ул. Ромашек д. 28', '2021-08-26', '2021-08-28', 'ожидается');
