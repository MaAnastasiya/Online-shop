        ...
        <div class="col-6 my-sm-3">
            ...
            <c:if test="${sessionScope.user == null}">
                ...
                <p class="text-muted"><fmt:message bundle="${loc}" key="language.noAccount"/> <a
                        href="/online_shop_war/online-shop?command=logUp"><fmt:message bundle="${loc}" key="language.logUp"/></a></p>
                <a href="/online_shop_war/online-shop?command=main"><fmt:message bundle="${loc}" key="language.home"/></a>
            </c:if>
        </div>
        <div class="col"></div>
    </div>
