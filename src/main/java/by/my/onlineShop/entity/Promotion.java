...
public class Promotion implements  Identifiable { // Акции
    private long id; // id акции
    private String name; // название акции
    private String description; // описание акции
    private byte discount; // скидка на акции
    private Date beginningDate; // начальная дата проведения акции
    private Date expirationDate; // конечная дата проведения акции
    private String photo; // фото на акции
