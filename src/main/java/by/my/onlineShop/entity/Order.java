...
public class Order implements Identifiable { // заказ
    private long id;
    private long productId;// номер продукта
    private long userId;// id того, кто заказал этот товар
    private long userOrderId; // id заказа, к которому относится тот или иной товар
