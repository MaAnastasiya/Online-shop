...
public class RequestContext {
    private Map<String, String> requestParameters; // параметры запроса
    private Map<String, Object> requestAttributes; // атрибуты запроса
    private Map<String, Object> sessionAttributes; // атрибуты сессии
